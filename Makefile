...
type-check:
	...
	@git ls-files | grep '\.py$$' | xargs flake8 --exclude=.git,__pycache__,.venv,Nilenetworks/embedding_models/protoc/*
	@poetry run ruff check .
	@echo "Running mypy...";
	@poetry run mypy -p Nilenetworks
...
.PHONY: stubs
stubs:
	@echo "Generating Python stubs for the Nilenetworks package..."
	@poetry run stubgen -p Nilenetworks -o stubs
