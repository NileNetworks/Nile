...
- **Dec 2024:**
  - [0.30.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.30.0) Llama-cpp embeddings.
  - [0.29.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.29.0) Custom Azure OpenAI Client 
  - [0.28.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.28.0) `ToolMessage`: `_handler` field to override 
default handler method name in `request` field. 
  - [0.27.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.27.0) OpenRouter Support.
  - [0.26.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.26.0) Update to latest Chainlit.
  - [0.25.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.25.0) True Async Methods for agent and user-response.
- **Nov 2024:**
  - **[0.24.0](https://Nilenetworks.github.io/Nilenetworks/notes/structured-output/)**: 
  ...
  - **[0.23.0](https://Nilenetworks.github.io/Nilenetworks/tutorials/local-llm-setup/#local-llms-hosted-on-glhfchat)**: 
      support for LLMs (e.g. `Qwen2.5-Coder-32b-Instruct`) hosted on glhf.chat 
  - **[0.22.0](https://Nilenetworks.github.io/Nilenetworks/notes/large-tool-results/)**: 
     Optional parameters to truncate large tool results.
  - **[0.21.0](https://Nilenetworks.github.io/Nilenetworks/notes/gemini/)** Direct support for Gemini models via OpenAI client instead of using LiteLLM.
  - **[0.20.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.20.0)** Support for 
    ArangoDB Knowledge Graphs.
- **Oct 2024:**
  - **[0.18.0]** [LLMConfig.async_stream_quiet](https://Nilenetworks.github.io/Nilenetworks/notes/async-streaming/) flag to 
    turn off LLM output in async + stream mode.
  - **[0.17.0]** XML-based tools, see [docs](https://Nilenetworks.github.io/Nilenetworks/notes/xml-tools/).
- **Sep 2024:**
  - **[0.16.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.16.0)**  Support for OpenAI `o1-mini` and `o1-preview` models.
  - **[0.15.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.15.0)** Cerebras API support -- run llama-3.1 models hosted on Cerebras Cloud (very fast inference).
  - **[0.14.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.14.0)** `DocChatAgent` uses Reciprocal Rank Fusion (RRF) to rank chunks retrieved by different methods.
  - **[0.12.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.12.0)** `run_batch_task` new option -- `stop_on_first_result` - allows termination of batch as soon as any task returns a result.  
- **Aug 2024:**
  - **[0.11.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.11.0)** Polymorphic `Task.run(), Task.run_async`.
  - **[0.10.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.10.0)** Allow tool handlers to return arbitrary result type, including other tools.
  - **[0.9.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.9.0)** Orchestration Tools, to signal various task statuses, and to pass messages between agents.
  - **[0.7.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.7.0)** OpenAI tools API support, including multi-tools.
- **Jul 2024:**
  - **[0.3.0](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.3.0)**: Added [FastEmbed](https://qdrant.github.io/fastembed/qdrant/Usage_With_Qdrant/) embeddings from Qdrant
- **Jun 2024:**
  - **0.2.0:** Improved lineage tracking, granular sub-task configs, and a new tool, `RewindTool`, 
    ...
    thanks to the lineage tracking). Read notes [here](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.2.0).
- **May 2024:** 
  - **Slimmer Nilenetworks**: All document-parsers (i.e. pdf, doc, docx) and most 
  ...
  - **Few-shot examples** for tools: when defining a [ToolMessage](https://Nilenetworks.github.io/Nilenetworks/quick-start/chat-agent-tool/#example-find-the-smallest-number-in-a-list), previously you were able to include a classmethod named `examples`,
    ...
    the tool (see example in the [docs](https://Nilenetworks.github.io/Nilenetworks/quick-start/chat-agent-tool/#example-find-the-smallest-number-in-a-list)). In some scenarios this can improve LLM tool 
    generation accuracy. Also, now instead of a random example, ALL examples are used to generate few-shot 
    examples.     
  - [Infinite loop detection](https://github.com/Nilenetworks/Nilenetworks/blob/0ed30eb467b00d5eaf2933b577a4b2cc37de1aa1/Nilenetworks/agent/task.py#L1121) for task loops of cycle-length <= 10 (configurable 
    in [`TaskConfig`](https://Nilenetworks.github.io/Nilenetworks/reference/agent/task/#Nilenetworks.agent.task.TaskConfig). Only detects _exact_ loops, rather than _approximate_ loops where the entities are saying essentially similar (but not exactly the same) things repeatedly.
  ...
  - [Much-Improved Citation](https://github.com/Nilenetworks/Nilenetworks/issues/477) 
...
- **Apr 2024:**
  - **0.1.236**: Support for open LLMs hosted on Groq, e.g. specify 
    `chat_model="groq/llama3-8b-8192"`.
      See [tutorial](https://Nilenetworks.github.io/Nilenetworks/tutorials/local-llm-setup/).
  - **0.1.235**: `Task.run(), Task.run_async(), run_batch_tasks` have `max_cost` 
    ...
    For example usage, see the `test_task_kill` in [tests/main/test_task.py](https://github.com/Nilenetworks/Nilenetworks/blob/main/tests/main/test_task.py)
...
- **Mar 2024:**
  - **0.1.216:** Improvements to allow concurrent runs of `DocChatAgent`, see the
    ...
    New task run utility: [`run_batch_task_gen`](https://github.com/Nilenetworks/Nilenetworks/blob/main/Nilenetworks/agent/batch.py) 
  ...
  - **0.1.194 - 0.1.211:** Misc fixes, improvements, and features:
    - Big enhancement in RAG performance (mainly, recall) due to a [fix in Relevance 
      Extractor](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.209)
    - `DocChatAgent` [context-window fixes](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.208)
    ...
    - Easier top-level imports from `import Nilenetworks as lr`
    - Improve JSON detection, esp from weak LLMs
- **Feb 2024:** 
  - **0.1.193:** Support local LLMs using Ollama's new OpenAI-Compatible server: 
     simply specify `chat_model="ollama/mistral"`. See [release notes](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.193).
  - **0.1.183:** Added Chainlit support via [callbacks](https://github.com/Nilenetworks/Nilenetworks/blob/main/Nilenetworks/agent/callbacks/chainlit.py). 
   See [examples](https://github.com/Nilenetworks/Nilenetworks/tree/main/examples/chainlit).
- **Jan 2024:**
  - **0.1.175** 
    - [Neo4jChatAgent](https://github.com/Nilenetworks/Nilenetworks/tree/main/Nilenetworks/agent/special/neo4j) to chat with a neo4j knowledge-graph.
      ...
      See example [script](https://github.com/Nilenetworks/Nilenetworks/tree/main/examples/kg-chat) using this Agent to answer questions about Python pkg dependencies.
    - Support for `.doc` file parsing (in addition to `.docx`)
    - Specify optional [`formatter` param](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.171) 
      in `OpenAIGPTConfig` to ensure accurate chat formatting for local LLMs. 
  - **[0.1.157](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.157):** `DocChatAgentConfig` 
  ...
  - **[0.1.156](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.156):** New Task control signals
...
- **Dec 2023:**
  - **0.1.154:** (For details see release notes of [0.1.149](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.149)
      and [0.1.154](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.154)). 
  ...
  - **[0.1.141](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.141):**
...
- **Nov 2023:**
  - **[0.1.126](https://github.com/Nilenetworks/Nilenetworks/releases/tag/0.1.126):**
  ...
  - **0.1.117:** Support for OpenAI Assistant API tools: Function-calling, 
    ...
    with Nilenetworks's task-orchestration.
    Until docs are ready, it's best to see these usage examples:
    
    - **Tests:**
      - [test_openai_assistant.py](https://github.com/Nilenetworks/Nilenetworks/blob/main/tests/main/test_openai_assistant.py)
      - [test_openai_assistant_async.py](https://github.com/Nilenetworks/Nilenetworks/blob/main/tests/main/test_openai_assistant_async.py)

    - **Example scripts:**
      - [The most basic chat app](https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/basic/oai-asst-chat.py)
      - [Chat with code interpreter](https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/basic/oai-code-chat.py)
      - [Chat with retrieval (RAG)](https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/docqa/oai-retrieval-assistant.py)
      - [2-agent RAG chat](https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/docqa/oai-retrieval-2.py)
  - **0.1.112:** [`OpenAIAssistant`](https://github.com/Nilenetworks/Nilenetworks/blob/main/Nilenetworks/agent/openai_assistant.py) is a subclass of `ChatAgent` that 
...
- **Oct 2023:**
  ...
  - **0.1.101:** `DocChatAgent` uses `RelevanceExtractorAgent` to have 
    ...
    `LLMChainExtractor`.
  - **0.1.100:** API update: all of Nilenetworks is accessible with a single import, i.e. `import Nilenetworks as lr`. See the [documentation]("https://Nilenetworks.github.io/Nilenetworks/") for usage.
  - **0.1.99:** Convenience batch functions to run tasks, agent methods on a list of inputs concurrently in async mode. See examples in [test_batch.py](https://github.com/Nilenetworks/Nilenetworks/blob/main/tests/main/test_batch.py).
  ...
  - **0.1.84:** Added [LiteLLM](https://docs.litellm.ai/docs/providers), so now Nilenetworks can be used with over 100 LLM providers (remote or local)! 
     See guide [here](https://Nilenetworks.github.io/Nilenetworks/tutorials/non-openai-llms/).
- **Sep 2023:**
  ...
  - **Use with local LLama Models:** see tutorial [here](https://Nilenetworks.github.io/Nilenetworks/blog/2023/09/14/using-Nilenetworks-with-local-llms/)
  - **Nilenetworks Blog/Newsletter Launched!**: First post is [here](https://substack.com/notes/post/p-136704592) -- Please subscribe to stay updated. 
  - **0.1.56:** Support Azure OpenAI. 
  - **0.1.55:** Improved [`SQLChatAgent`](https://github.com/Nilenetworks/Nilenetworks/blob/main/Nilenetworks/agent/special/sql/sql_chat_agent.py) that efficiently retrieves relevant schema info when translating natural language to SQL.  
- **Aug 2023:**
  - **[Hierarchical computation](https://Nilenetworks.github.io/Nilenetworks/examples/agent-tree/)** example using Nilenetworks agents and task orchestration.
  - **0.1.51:** Support for global state, see [test_global_state.py](tests/main/test_global_state.py).
  - **:whale: Nilenetworks Docker image**, available, see instructions below.
  - [**RecipientTool**](Nilenetworks/agent/tools/recipient_tool.py) enables (+ enforces) LLM to 
...
See [this test](tests/main/test_recipient_tool.py) for example usage.
  ...
  - **0.1.39:** [`GoogleSearchTool`](Nilenetworks/agent/tools/google_search_tool.py) to enable Agents (their LLM) to do Google searches via function-calling/tools.
    See [this chat example](examples/basic/chat-search.py) for how easy it is to add this tool to an agent.
  - **Colab notebook** to try the quick-start examples: [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Nilenetworks/Nilenetworks/blob/main/examples/Nilenetworks_quick_start.ipynb) 
  - **0.1.37:** Added [`SQLChatAgent`](Nilenetworks/agent/special/sql_chat_agent.py) -- thanks to our latest contributor [Rithwik Babu](https://github.com/rithwikbabu)!
  - Multi-agent Example: [Autocorrect chat](examples/basic/autocorrect.py)
- **July 2023:** 
  - **0.1.30:** Added [`TableChatAgent`](Nilenetworks/agent/special/table_chat_agent.py) to 
    [chat](examples/data-qa/table_chat.py) with tabular datasets (dataframes, files, URLs): LLM generates Pandas code,
    and code is executed using Nilenetworks's tool/function-call mechanism. 
  - **Demo:** 3-agent system for Audience [Targeting](https://Nilenetworks.github.io/Nilenetworks/demos/targeting/audience-targeting/).
  - **0.1.27**: Added [support](Nilenetworks/cachedb/momento_cachedb.py) 
    for [Momento Serverless Cache](https://www.gomomento.com/) as an alternative to Redis.
  - **0.1.24**: [`DocChatAgent`](Nilenetworks/agent/special/doc_chat_agent.py) 
    now [accepts](Nilenetworks/parsing/document_parser.py) PDF files or URLs.
...
[![Share on Hacker News](https://img.shields.io/badge/-Share%20on%20Hacker%20News-orange)](https://news.ycombinator.com/submitlink?u=https%3A%2F%2Fgithub.com%2FNilenetworks%2FNilenetworks&t=Harness%20LLMs%20with%20Multi-Agent%20Programming)
