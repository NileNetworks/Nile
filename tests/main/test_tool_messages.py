...
from Nilenetworks.agent.tools import DoneTool
...
from Nilenetworks.language_models.mock_lm import MockLMConfig
...
from Nilenetworks.pydantic_v1 import BaseModel, Field
...
def test_llm_tool_message(
    ...
    Args:
        ...
        use_functions_api: whether to use LLM's functions api or not
            (i.e. use the Nilenetworks ToolMessage tools instead).
...
def test_oai_tool_choice(
    ...
    set_global(test_settings)
    cfg = ChatAgentConfig(
        use_tools=False,  # Nilenetworks tools
