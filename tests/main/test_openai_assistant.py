...
from Nilenetworks.agent.openai_assistant import (
    AssistantTool,
    OpenAIAssistant,
...
def test_openai_assistant_fn_tool(test_settings: Settings, fn_api: bool):
    ...
    Nilenetworks native ToolMessage mechanism"""
...
We will update Nilenetworks to catch up with this at some point.
"""
)
