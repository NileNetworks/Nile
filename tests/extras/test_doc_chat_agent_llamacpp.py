...
from Nilenetworks import ChatDocument
from Nilenetworks.agent.batch import run_batch_task_gen, run_batch_tasks
from Nilenetworks.agent.chat_agent import ChatAgent
from Nilenetworks.agent.special.doc_chat_agent import (
    DocChatAgent,
    DocChatAgentConfig,
    RetrievalTool,
)
from Nilenetworks.agent.special.lance_doc_chat_agent import LanceDocChatAgent
from Nilenetworks.agent.task import Task
from Nilenetworks.embedding_models.models import LlamaCppServerEmbeddingsConfig
from Nilenetworks.language_models import GeminiModel, OpenAIChatModel
...
from Nilenetworks.parsing.parser import ParsingConfig, Splitter
from Nilenetworks.parsing.utils import generate_random_text
...
from Nilenetworks.utils.output.citations import extract_markdown_references
from Nilenetworks.utils.system import rmdir
from Nilenetworks.vector_store.base import VectorStore, VectorStoreConfig
from Nilenetworks.vector_store.chromadb import ChromaDB, ChromaDBConfig
from Nilenetworks.vector_store.lancedb import LanceDB, LanceDBConfig
from Nilenetworks.vector_store.qdrantdb import QdrantDB, QdrantDBConfig

"""
    Pytest for running Nilenetworks DocAgent with llama.cpp server acting as the 
    embeddings host.
    Not designed for main usage, but this has been useful for validating if local models
    are sufficient to run Nilenetworks. Feel free to delete!
