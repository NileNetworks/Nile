"""
Use Nilenetworks to set up a collaboration among three agents:
...
[Getting Started guide](https://Nilenetworks.github.io/Nilenetworks/quick-start/three-agent-chat-num-router/)
"""
...
def main(
    ...
    tools: bool = typer.Option(
        ...
        "--tools",
        "-t",
        help="use Nilenetworks tools instead of OpenAI function-calling",
    ),
) -> None:
