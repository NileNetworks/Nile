"""
A simple example of a Nilenetworks Agent equipped with a Tool/function-calling.
...
[the Getting Started guide](https://Nilenetworks.github.io/Nilenetworks/quick-start/chat-agent-tool/).
"""
