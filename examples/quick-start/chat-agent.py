"""
This example shows how you can use Nilenetworks to define a basic Agent
...
More details in the
[Getting Started guide](https://Nilenetworks.github.io/Nilenetworks/quick-start/chat-agent/)
"""
