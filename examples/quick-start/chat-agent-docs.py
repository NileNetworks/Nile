"""
Example of a Nilenetworks DocChatAgent equipped with a vector-store and LLM.
...
[the Getting Started guide](https://Nilenetworks.github.io/Nilenetworks/quick-start/chat-agent-docs/).
"""
