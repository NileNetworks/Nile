"""
This example shows how to use Nilenetworks to interact directly with an OpenAI GPT chat model,
...
[Getting Started guide](https://Nilenetworks.github.io/Nilenetworks/quick-start/llm-interaction/)
"""
...
def chat() -> None:
    print("[blue]Welcome to Nilenetworks!")
