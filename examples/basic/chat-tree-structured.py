...
Hiearchical Agent Computations at https://Nilenetworks.github.io/Nilenetworks/examples/agent-tree/

For more details on structured outputs, see the notes at
https://Nilenetworks.github.io/Nilenetworks/notes/structured-output/.
"""
