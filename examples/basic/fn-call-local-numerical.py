...
See more here: https://Nilenetworks.github.io/Nilenetworks/quick-start/chat-agent-tool/
...
See here for ways to set up a Local/Open LLM to work with Nilenetworks:
...
from Nilenetworks.language_models.openai_gpt import OpenAICallParams
...
from Nilenetworks.agent.tools.orchestration import ForwardTool
