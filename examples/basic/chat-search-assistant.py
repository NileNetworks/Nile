...
or `-m ollama/mistral` etc. See here how to use Nilenetworks with local LLMs:
...
[README](https://github.com/Nilenetworks/Nilenetworks#gear-installation-and-setup).
...
* install Nilenetworks with the `metaphor` extra, e.g.
`pip install Nilenetworks[metaphor]` or `poetry add Nilenetworks[metaphor]`
...
from Nilenetworks.agent.tools.google_search_tool import GoogleSearchTool
from Nilenetworks.agent.tools.duckduckgo_search_tool import DuckduckgoSearchTool
...
def main(
    ...
    match provider:
        ...
        case "metaphor":
            from Nilenetworks.agent.tools.metaphor_search_tool import MetaphorSearchTool
