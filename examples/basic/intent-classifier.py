...
For more ways to use Nilenetworks with other LLMs, see:
- local/open LLMs: https://Nilenetworks.github.io/Nilenetworks/tutorials/local-llm-setup/
- non-OpenAPI LLMs: https://Nilenetworks.github.io/Nilenetworks/tutorials/non-openai-llms/
"""
...
def main(model: str = ""):
    ...
    agent = lr.ChatAgent(
        lr.ChatAgentConfig(
            ...
            use_tools=True,  # use Nilenetworks-native tools: works with ANY LLM
            system_message=f"""
