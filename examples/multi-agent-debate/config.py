...
import Nilenetworks.utils.configuration
from Nilenetworks.language_models import OpenAIGPTConfig
...
def get_global_settings(debug: bool = False, nocache: bool = True) -> Settings:
    """
    Retrieve global Nilenetworks settings.
    ...
    Returns:
        Settings: Nilenetworks's global configuration object.
    """
    return Nilenetworks.utils.configuration.Settings(
        debug=debug,
        cache=not nocache,
    )
