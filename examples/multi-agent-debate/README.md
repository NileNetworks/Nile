...
Overview
--------
This project is a debate system powered by LLMs using Nilenetworks, enabling structured debates on various topics 
...
Prerequisites
1. Python 3.8+
2. Nilenetworks Framework: Install Nilenetworks with necessary dependencies:
...
4. Please read the following page for more information:
   https://Nilenetworks.github.io/Nilenetworks/quick-start/setup/

Usage
-----
Run the CLI Application
Start the application from the root of the Nilenetworks repo with:
