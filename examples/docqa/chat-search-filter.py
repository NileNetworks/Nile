...
(See here for guide to using local LLMs with Nilenetworks:)
...
from Nilenetworks.agent.chat_agent import ChatAgent, ChatDocument
from Nilenetworks.agent.special.doc_chat_agent import (
    DocChatAgent,
    DocChatAgentConfig,
)
from Nilenetworks.parsing.web_search import metaphor_search
from Nilenetworks.parsing.parser import ParsingConfig, Splitter, PdfParsingConfig
