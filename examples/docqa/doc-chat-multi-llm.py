...
See this [script](https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/docqa/rag-local-simple.py)
 for examples of specifying local models.

See here for a guide on how to use Nilenetworks with non-OpenAI LLMs (local/remote):
...
import Nilenetworks.language_models.base
...
def main(
    ...
    print(str(Nilenetworks.language_models.base.LanguageModel.usage_cost_summary()))
