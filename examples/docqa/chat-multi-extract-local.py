...
Solution with Nilenetworks Agents and tools:
...
from Nilenetworks.utils.constants import NO_ANSWER, DONE
from Nilenetworks.utils.pydantic_utils import get_field_names
