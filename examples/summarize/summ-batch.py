...
First see instructions to install Nilenetworks
in the README of the Nilenetworks-examples repo:
https://github.com/Nilenetworks/Nilenetworks-examples
...
See here for more details on how to set up a Local LLM to work with Nilenetworks:
