...
If using litellm, remember to install Nilenetworks with the litellm extra, e.g.
pip install "Nilenetworks[litellm]"

See these guides for info on setting up Nilenetworks to use Open/Local LLMs
and other non-OpenAI LLMs:
- https://Nilenetworks.github.io/Nilenetworks/tutorials/local-llm-setup/
- https://Nilenetworks.github.io/Nilenetworks/tutorials/non-openai-llms/
"""
...
from Nilenetworks import TaskConfig
from Nilenetworks.agent.special.arangodb.arangodb_agent import (
...
def main(
    ...
    if url == "got":
        ...
        connection = get_temp_credentials(tutorialName="Nilenetworks")
