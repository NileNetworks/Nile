...
described here
`https://github.com/Nilenetworks/Nilenetworks/tree/main/examples/kg-chat#requirements`

The rest of requirements are described in
 `https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/kg-chat/README.md`
...
from Nilenetworks.utils.constants import NO_ANSWER, SEND_TO
...
def main(
    ...
    tools: bool = typer.Option(
        False, "--tools", "-t", help="use Nilenetworks tools instead of function-calling"
    ),
