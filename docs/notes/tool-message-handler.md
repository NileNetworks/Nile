...
within the `MyTool` class itself, and Nilenetworks will insert this method into the `Agent`,
with name `my_tool`. 
See the quick-start [Tool section](https://Nilenetworks.github.io/Nilenetworks/quick-start/chat-agent-tool/) for more details.
...
Refer to [examples/basic/tool-custom-handler.py](https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/basic/tool-custom-handler.py)
