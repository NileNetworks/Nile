...
- *Programming skills:* Using an LLM API involves either:
    ...
    - use a scaffolding library (like [Nilenetworks](https://github.com/Nilenetworks/Nilenetworks)) that abstracts away the details of the 
      API calls.
...
a scaffolding library like [Nilenetworks](https://github.com/Nilenetworks/Nilenetworks) comes in
...
than directly working with the raw API. Below are instructions on how to use Nilenetworks
with some the above Open/Local LLM options.

See [here](https://Nilenetworks.github.io/Nilenetworks/tutorials/local-llm-setup/) for 
a guide to using Nilenetworks with Open LLMs.
