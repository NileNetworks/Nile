...
from Nilenetworks.mytypes import Embeddings
from Nilenetworks.parsing.utils import batched
    ...
    def __init__(self, config: STEC = STEC()):
        ...
        try:
            ...
            raise ImportError(
                ...
                you must install Nilenetworks with the [hf-embeddings] extra, e.g.:
...
class FastEmbedEmbeddings(EmbeddingModel):
    def __init__(self, config: FastEmbedEmbeddingsConfig = FastEmbedEmbeddingsConfig()):
        try:
            ...
            raise NilenetworksImportError("fastembed", extra="fastembed")
