...
For example:
python3 -m Nilenetworks.embedding_models.remote_embeds --port `port`
...
import Nilenetworks.embedding_models.models as em
import Nilenetworks.embedding_models.protoc.embeddings_pb2 as embeddings_pb
import Nilenetworks.embedding_models.protoc.embeddings_pb2_grpc as embeddings_grpc
