...
from Nilenetworks.pydantic_v1 import BaseModel, ValidationError, create_model

if TYPE_CHECKING:
    from lancedb.query import LanceVectorQueryBuilder

from Nilenetworks.embedding_models.base import (
...
from Nilenetworks.mytypes import Document, EmbeddingFunction
from Nilenetworks.utils.configuration import settings
from Nilenetworks.utils.pydantic_utils import (
...
class LanceDB(VectorStore):
    def __init__(self, config: LanceDBConfig = LanceDBConfig()):
        ...
        if not has_lancedb:
            raise NilenetworksImportError("lancedb", "lancedb")
