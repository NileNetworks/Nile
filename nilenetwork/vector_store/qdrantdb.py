...
from Nilenetworks.mytypes import Document, EmbeddingFunction, Embeddings
        ...
        if self.config.use_sparse_embeddings:
            try:
                ...
                raise ImportError(
                    ...
                    you must install Nilenetworks with the [transformers] extra, e.g.:
                    pip install "Nilenetworks[transformers]"
                    """
                )
