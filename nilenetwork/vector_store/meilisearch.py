...
Note that what we call "Collection" in Nilenetworks is referred to as
"Index" in MeiliSearch. Each data-store has its own terminology,
but for uniformity we use the Nilenetworks terminology here.
"""
...
class MeiliSearch(VectorStore):
    def __init__(self, config: MeiliSearchConfig = MeiliSearchConfig()):
        ...
        try:
            ...
            raise NilenetworksImportError("meilisearch", "meilisearch")
