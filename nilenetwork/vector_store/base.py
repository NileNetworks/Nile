...
from Nilenetworks.embedding_models.base import EmbeddingModel, EmbeddingModelsConfig
from Nilenetworks.embedding_models.models import OpenAIEmbeddingsConfig
from Nilenetworks.mytypes import DocMetaData, Document
from Nilenetworks.pydantic_v1 import BaseSettings
from Nilenetworks.utils.algorithms.graph import components, topological_sort
from Nilenetworks.utils.configuration import settings
from Nilenetworks.utils.object_registry import ObjectRegistry
from Nilenetworks.utils.output.printing import print_long_text
from Nilenetworks.utils.pandas_utils import stringify
from Nilenetworks.utils.pydantic_utils import flatten_dict
...
class VectorStoreConfig(BaseSettings):
    ...
    # compose_file: str = "Nilenetworks/vector_store/docker-compose-qdrant.yml"
...
class VectorStore(ABC):
    ...
    def create(config: VectorStoreConfig) -> Optional["VectorStore"]:
        ...
        from Nilenetworks.vector_store.meilisearch import MeiliSearch, MeiliSearchConfig
        from Nilenetworks.vector_store.momento import MomentoVI, MomentoVIConfig
