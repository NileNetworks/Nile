...
Nilenetworks with the [hf-embeddings] extra, e.g.:
...
from Nilenetworks.agent.batch import run_batch_tasks
from Nilenetworks.agent.chat_agent import ChatAgent, ChatAgentConfig
from Nilenetworks.agent.chat_document import ChatDocMetaData, ChatDocument
from Nilenetworks.agent.special.relevance_extractor_agent import (
    RelevanceExtractorAgent,
    RelevanceExtractorAgentConfig,
)
from Nilenetworks.agent.task import Task
from Nilenetworks.agent.tools.retrieval_tool import RetrievalTool
from Nilenetworks.embedding_models.models import (
    OpenAIEmbeddingsConfig,
    SentenceTransformerEmbeddingsConfig,
)
from Nilenetworks.language_models.base import StreamingIfAllowed
from Nilenetworks.language_models.openai_gpt import OpenAIChatModel, OpenAIGPTConfig
from Nilenetworks.mytypes import DocMetaData, Document, Entity
from Nilenetworks.parsing.document_parser import DocumentType
from Nilenetworks.parsing.parser import Parser, ParsingConfig, PdfParsingConfig, Splitter
from Nilenetworks.parsing.repo_loader import RepoLoader
from Nilenetworks.parsing.search import (
    find_closest_matches_with_bm25,
    find_fuzzy_matches_in_docs,
    preprocess_text,
)
from Nilenetworks.parsing.table_loader import describe_dataframe
from Nilenetworks.parsing.url_loader import URLLoader
from Nilenetworks.parsing.urls import get_list_from_user, get_urls_paths_bytes_indices
from Nilenetworks.prompts.prompts_config import PromptsConfig
from Nilenetworks.prompts.templates import SUMMARY_ANSWER_PROMPT_GPT4
from Nilenetworks.utils.constants import NO_ANSWER
from Nilenetworks.utils.object_registry import ObjectRegistry
from Nilenetworks.utils.output import show_if_debug, status
from Nilenetworks.utils.output.citations import (
    extract_markdown_references,
    format_footnote_text,
)
from Nilenetworks.utils.pydantic_utils import dataframe_to_documents, extract_fields
from Nilenetworks.vector_store.base import VectorStore, VectorStoreConfig
from Nilenetworks.vector_store.qdrantdb import QdrantDBConfig
...
class DocChatAgent(ChatAgent):
    ...
    def get_semantic_search_results(
        ...
        # `Nilenetworks/utils/pydantic_utils.py`
