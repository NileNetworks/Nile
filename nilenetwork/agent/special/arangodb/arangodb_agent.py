...
from Nilenetworks.agent.special.arangodb.system_messages import (
...
from Nilenetworks.agent.special.arangodb.tools import (
    AQLCreationTool,
    AQLRetrievalTool,
    ArangoSchemaTool,
...
from Nilenetworks.agent.special.arangodb.utils import count_fields, trim_schema
from Nilenetworks.agent.tools.orchestration import DoneTool, ForwardTool
from Nilenetworks.exceptions import NilenetworksImportError
from Nilenetworks.mytypes import Entity
from Nilenetworks.pydantic_v1 import BaseModel, BaseSettings
from Nilenetworks.utils.constants import SEND_TO
...
class ArangoChatAgent(ChatAgent):
    ...
    def _import_arango(self) -> None:
        ...
        try:
            ...
            raise NilenetworksImportError("python-arango", "arango")
