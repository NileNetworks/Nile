...
from Nilenetworks.agent.special.neo4j.system_messages import (
...
from Nilenetworks.agent.special.neo4j.tools import (
    CypherCreationTool,
    CypherRetrievalTool,
    GraphSchemaTool,
...
class Neo4jChatAgent(ChatAgent):
    ...
    def _import_neo4j(self) -> None:
        ...
        try:
            ...
            raise NilenetworksImportError("neo4j", "neo4j")
