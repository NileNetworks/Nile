...
from Nilenetworks.parsing.agent_chats import parse_message
from Nilenetworks.parsing.parse_json import extract_top_level_json, top_level_json_field
from Nilenetworks.pydantic_v1 import BaseModel, Extra
from Nilenetworks.utils.object_registry import ObjectRegistry
from Nilenetworks.utils.output.printing import shorten_text
...
class ChatDocument(Document):
    ...
    Attributes:
        ...
        tool_messages (List[ToolMessage]): Nilenetworks ToolMessages extracted from
    ...
    def _clean_fn_call(fc: LLMFunctionCall | None) -> None:
        ...
        #  and in Nilenetworks we use the `request` value as the `name`.
