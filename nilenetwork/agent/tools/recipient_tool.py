...
are inserted into the Agent as methods (see `Nilenetworks/agent/base.py`,
...
https://github.com/Nilenetworks/Nilenetworks/blob/main/Nilenetworks/agent/tools/orchestration.py

You can also define your own XML-based variant of this tool:
https://github.com/Nilenetworks/Nilenetworks/blob/main/examples/basic/xml-tool.py
...
from Nilenetworks.utils.pydantic_utils import has_field
