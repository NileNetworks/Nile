...
from Nilenetworks.agent.base import Agent
from Nilenetworks.agent.chat_agent import ChatAgent
from Nilenetworks.agent.chat_document import (
    ChatDocLoggerFields,
    ChatDocMetaData,
    ChatDocument,
    StatusCode,
...
from Nilenetworks.agent.tools.orchestration import AgentDoneTool, DoneTool, FinalResultTool
from Nilenetworks.cachedb.redis_cachedb import RedisCache, RedisCacheConfig
from Nilenetworks.exceptions import InfiniteLoopException
from Nilenetworks.mytypes import Entity
from Nilenetworks.parsing.parse_json import extract_top_level_json
from Nilenetworks.parsing.routing import parse_addressed_message
from Nilenetworks.pydantic_v1 import BaseModel
from Nilenetworks.utils.configuration import settings
from Nilenetworks.utils.constants import (
    DONE,
    NO_ANSWER,
    PASS,
    PASS_TO,
...
from Nilenetworks.utils.logging import RichFileLogger, setup_file_logger
from Nilenetworks.utils.object_registry import scheduled_cleanup
from Nilenetworks.utils.system import hash
from Nilenetworks.utils.types import to_string
...
class TaskConfig(BaseModel):
    ...
    Attributes:
        ...
        addressing_prefix (str): "@"-like prefix an agent can use to address other
            ...
            setting is to use `Nilenetworks.utils.constants.AT`, which currently is "|@|".
        ...
        Args:
            ...
            allow_null_result (bool):
                ...
                *Note:* In non-interactive mode, when this is set to True,
                ...
                otherwise Nilenetworks detects a potential infinite loop after
        ...
        while True:
            ...
            if (
                ...
                raise InfiniteLoopException(
                    ...
                    https://Nilenetworks.github.io/Nilenetworks/reference/agent/task/#Nilenetworks.agent.task.TaskConfig
                    """
                )
