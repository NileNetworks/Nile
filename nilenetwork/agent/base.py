...
from Nilenetworks.language_models.openai_gpt import OpenAIGPT, OpenAIGPTConfig
...
from Nilenetworks.pydantic_v1 import (
    BaseSettings,
    Field,
    ValidationError,
    validator,
...
from Nilenetworks.utils.types import from_string, to_string
...
class Agent(ABC):
    ...
    def get_tool_messages(
        ...
        if len(msg.tool_messages) > 0:
            ...
            # (either via OpenAI Fn-call or Nilenetworks-native ToolMessage);
    ...
    def handle_message(
        ...
        Returns:
            The result of the handler method can be:
             ...
             - str if Nilenetworks-native JSON tools were handled, and results concatenated,
