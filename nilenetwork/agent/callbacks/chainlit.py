...
try:
    ...
    raise NilenetworksImportError("chainlit", "chainlit")
...
class ChainlitAgentCallbacks:
    """Inject Chainlit callbacks into a Nilenetworks Agent"""
...
class ChainlitTaskCallbacks(ChainlitAgentCallbacks):
    """
    Recursively inject ChainlitAgentCallbacks into a Nilenetworks Task's agent and
    agents of sub-tasks.
    """
