...
from Nilenetworks.cachedb.base import CacheDB
from Nilenetworks.cachedb.redis_cachedb import RedisCache, RedisCacheConfig
from Nilenetworks.exceptions import NilenetworksImportError
...
from Nilenetworks.language_models.config import HFPromptFormatterConfig
from Nilenetworks.language_models.prompt_formatter.hf_formatter import (
    HFFormatter,
    find_hf_formatter,
)
from Nilenetworks.language_models.utils import (
    async_retry_with_exponential_backoff,
    retry_with_exponential_backoff,
)
from Nilenetworks.parsing.parse_json import parse_imperfect_json
from Nilenetworks.pydantic_v1 import BaseModel
from Nilenetworks.utils.configuration import settings
from Nilenetworks.utils.constants import Colors
from Nilenetworks.utils.system import friendly_error
...
class OpenAIGPTConfig(LLMConfig):
    ...
    def _validate_litellm(self) -> None:
        ...
        try:
            ...
            raise NilenetworksImportError("litellm", "litellm")
...
class OpenAIGPT(LanguageModel):
    ...
    def __init__(self, config: OpenAIGPTConfig = OpenAIGPTConfig()):
        ...
        if settings.cache_type == "momento" and use_cache:
            from Nilenetworks.cachedb.momento_cachedb import (
                MomentoCache,
                MomentoCacheConfig,
            )
    ...
    def chat(
        ...
        if [functions, tools] != [None, None] and not self.is_openai_chat_model():
            raise ValueError(
                ...
                Instead, please use Nilenetworks's ToolMessages, which are equivalent.
