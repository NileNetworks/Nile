...
from Nilenetworks.language_models.base import LanguageModel, LLMMessage, Role
from Nilenetworks.language_models.config import HFPromptFormatterConfig
from Nilenetworks.language_models.prompt_formatter.base import PromptFormatter
...
def try_import_hf_modules() -> Tuple[Type[Any], Type[Any]]:
    ...
    try:
        ...
        raise ImportError(
            ...
            by default with Nilenetworks. Please install Nilenetworks using the 
