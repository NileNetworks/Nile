...
from Nilenetworks.language_models.config import PromptFormatterConfig
...
class PromptFormatter(ABC):
    ...
    def create(formatter: str) -> "PromptFormatter":
        ...
        from Nilenetworks.language_models.prompt_formatter.hf_formatter import HFFormatter
