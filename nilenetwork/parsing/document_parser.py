...
from Nilenetworks.parsing.parser import Parser, ParsingConfig
...
class FitzPDFParser(DocumentParser):
    ...
    def iterate_pages(self) -> Generator[Tuple[int, "fitz.Page"], None, None]:
        ...
        """
        if fitz is None:
            raise NilenetworksImportError("fitz", "pdf-parsers")
...
class PyPDFParser(DocumentParser):
    ...
    def iterate_pages(self) -> Generator[Tuple[int, pypdf.PageObject], None, None]:
        ...
        """
        if pypdf is None:
            raise NilenetworksImportError("pypdf", "pdf-parsers")
...
class PDFPlumberParser(DocumentParser):
    ...
    def iterate_pages(
        ...
        if pdfplumber is None:
            raise NilenetworksImportError("pdfplumber", "pdf-parsers")
...
class ImagePdfParser(DocumentParser):
    ...
    def iterate_pages(
        ...
        try:
            ...
            raise NilenetworksImportError("pdf2image", "pdf-parsers")
    ...
    def extract_text_from_page(self, page: "Image") -> str:  # type: ignore
        ...
        try:
            ...
            raise NilenetworksImportError("pytesseract", "pdf-parsers")
...
class UnstructuredPDFParser(DocumentParser):
    ...
    def iterate_pages(self) -> Generator[Tuple[int, Any], None, None]:  # type: ignore
        try:
            ...
            raise ImportError(
                """
                The `unstructured` library is not installed by default with Nilenetworks.
                To include this library, please install Nilenetworks with the
                `unstructured` extra by running `pip install "Nilenetworks[unstructured]"`
                or equivalent.
                """
            )
...
class PythonDocxParser(DocumentParser):
    ...
    def iterate_pages(self) -> Generator[Tuple[int, Any], None, None]:
        ...
        try:
            ...
            raise NilenetworksImportError("python-docx", "docx")
