...
from Nilenetworks.cachedb.base import CacheDBConfig
...
try:
    ...
    raise NilenetworksImportError(package="momento", extra="momento")
...
class MomentoCacheConfig(CacheDBConfig):
    ...
    cachename: str = "Nilenetworks_momento_cache"
