# Contributing to Nilenetworks

Thank you for your interest in contributing to Nilenetworks!
We want to fundamentally change how LLM applications are built, 
using Nilenetworks's principled multi-agent framework. 
Together, let us build the future of LLM-apps!
We welcome contributions from everyone.

Below you will find guidelines and suggestions for contributing.
We explicitly designed Nilenetworks with a transparent, flexible architecture to 
make it easier to build LLM-powered applications, as well as 
to make it easier to contribute to Nilenetworks itself.
Feel free to join us on [Discord](https://discord.gg/ZU36McDgDs) 
for any questions or discussions.

# How can I Contribute?

There are many ways to contribute to Nilenetworks. Here are some areas where you can help:
...
You are welcome to take on un-assigned open [issues](https://github.com/Nilenetworks/Nilenetworks/issues).
...
- [x] **Integrate LLM APIs:** There are a couple of libs that simulate OpenAI-like interface for other models: https://github.com/BerriAI/litellm
    and https://github.com/philschmid/easyllm. It would be useful to have Nilenetworks work with these APIs.
...
generate a function-call or Nilenetworks-tool-message, which the agent’s 
...
- [ ] **Text labeling/classification:** Specifically do what this repo does: https://github.com/refuel-ai/autolabel, 
  but using Nilenetworks instead of Langchain (which that repo uses).
...
- [ ] Document classification based on rules in an unstructured “policy” document. 
    ...
    This would be a perfect use-case for Nilenetworks’s multi-agent system. 
...
- [ ] Implement Stanford’s Simulacra paper with Nilenetworks.
Generative Agents: Interactive Simulacra of Human Behavior https://arxiv.org/abs/2304.03442

- [ ] Implement CMU's paper with Nilenetworks.
...
direct imports from pydantic, and replaces them with importing from `Nilenetworks.pydantic_v1`
